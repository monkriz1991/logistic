            ...
            <div class="container">
                <div class="kinesis-desc">
                    <kinesis-element :strength="10">
                        ...
                        tag="strong"
                        :strength="10" 
                        type="depth">F</kinesis-element>
                        <kinesis-element 
                        tag="strong"
                        :strength="9" 
                        type="depth">r</kinesis-element>
                        <kinesis-element 
                        tag="strong"
                        :strength="8" 
...
.kinesis-desc h1 strong{
    font-size: 66px;
    font-weight: 800;
}
.kinesis-desc h1 span{
    font-size: 33px;
    width: 100%;
    float: left;
    font-weight: 600;
